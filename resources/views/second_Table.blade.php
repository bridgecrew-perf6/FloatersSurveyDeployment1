<div id="container1" style="width: 40%;">
  ...
  <div class="row">
    ...
    <select class="form-control" name="Eye_Diseases" id="Eye_Diseases">
      <option>please choose an option</option>
      <option <?php if(request()->get('Eye_Diseases')=='Longsighted_yes') echo "selected"?> value="Longsighted_yes">Long sighted</option>
      <option <?php if((request()->get('Eye_Diseases')!==null) && request()->get('Eye_Diseases')=='shortsighted_yes') echo "selected"?> value="shortsighted_yes">short sighted</option>
    </select>
    </div>
