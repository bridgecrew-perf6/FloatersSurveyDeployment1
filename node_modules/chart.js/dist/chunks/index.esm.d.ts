...
type Scriptable<T, TContext> = T | ((ctx: TContext) => T);
...
interface Defaults extends CoreChartOptions<ChartType>, ElementChartOptions, PluginChartOptions<ChartType> {
...
interface Plugin<TType extends ChartType = ChartType, O = AnyObject> extends ExtendedPlugin<TType> {
  id: string;
...
interface BarOptions extends CommonElementOptions {
  /**
...
declare enum DecimationAlgorithm {
  lttb = 'lttb',
  minmax = 'min-max',
}
...
interface LegendElement extends Element, LayoutItem {}
...
interface TooltipModel<TType extends ChartType> {
...
interface TooltipOptions<TType extends ChartType> extends CoreInteractionOptions {
  /**
...
type ScaleOptionsByType<TScale extends ScaleType = ScaleType> = DeepPartial<
...
export { Defaults as $, AnyObject as A, BarControllerDatasetOptions as B, ChartArea as C, DoughnutControllerDatasetOptions as D, EasingFunction as E, FontSpec as F, PieController as G, PolarAreaControllerDatasetOptions as H, PolarAreaAnimationOptions as I, PolarAreaControllerChartOptions as J, PolarAreaController as K, LineControllerDatasetOptions as L, RadarControllerChartOptions as M, RadarController as N, ChartMeta as O, PointStyle as P, ActiveDataPoint as Q, RadarControllerDatasetOptions as R, ScriptableContext as S, ActiveElement as T, Chart as U, registerables as V, ChartItem as W, UpdateModeEnum as X, UpdateMode as Y, DatasetController as Z, DatasetControllerChartComponent as _, Color as a, ComplexFillTarget as a$, Overrides as a0, defaults as a1, InteractionOptions as a2, InteractionItem as a3, InteractionModeFunction as a4, InteractionModeMap as a5, InteractionMode as a6, Interaction as a7, layouts as a8, Plugin as a9, ArcHoverOptions as aA, ArcElement as aB, LineProps as aC, LineOptions as aD, LineHoverOptions as aE, LineElement as aF, PointProps as aG, PointOptions as aH, PointHoverOptions as aI, PointPrefixedOptions as aJ, PointPrefixedHoverOptions as aK, PointElement as aL, BarProps as aM, BarOptions as aN, BorderRadius as aO, BarHoverOptions as aP, BarElement as aQ, ElementOptionsByType as aR, ElementChartOptions as aS, BasePlatform as aT, BasicPlatform as aU, DomPlatform as aV, DecimationAlgorithm as aW, DecimationOptions as aX, Filler as aY, FillerOptions as aZ, FillTarget as a_, ChartComponentLike as aa, Registry as ab, registry as ac, Tick as ad, CoreScaleOptions as ae, Scale as af, ScriptableScaleContext as ag, Ticks as ah, TypedRegistry as ai, ChartEvent as aj, ChartComponent as ak, CoreInteractionOptions as al, HoverInteractionOptions as am, CoreChartOptions as an, AnimationSpec as ao, AnimationsSpec as ap, TransitionSpec as aq, TransitionsSpec as ar, AnimationOptions as as, TextAlign as at, VisualElement as au, CommonElementOptions as av, CommonHoverOptions as aw, Segment as ax, ArcProps as ay, ArcOptions as az, Scriptable as b, FillerControllerDatasetOptions as b0, Legend as b1, LegendItem as b2, LegendElement as b3, LegendOptions as b4, Title as b5, TitleOptions as b6, TooltipAlignment as b7, TooltipModel as b8, Tooltip as b9, ChartType as bA, ScaleOptionsByType as bB, DatasetChartOptions as bC, ScaleChartOptions as bD, ChartOptions as bE, DefaultDataPoint as bF, ParsedDataType as bG, ChartDatasetProperties as bH, ChartDataset as bI, ChartData as bJ, ChartConfiguration as bK, DateAdapter as bL, TimeUnit as bM, _adapters as bN, Animation as bO, Animations as bP, Animator as bQ, AnimationEvent as bR, Element as bS, Point as bT, LayoutItem as bU, LayoutPosition as bV, TooltipCallbacks as ba, ExtendedPlugin as bb, ScriptableTooltipContext as bc, TooltipOptions as bd, TooltipItem as be, PluginOptionsByType as bf, PluginChartOptions as bg, GridLineOptions as bh, TickOptions as bi, CartesianScaleOptions as bj, CategoryScaleOptions as bk, CategoryScale as bl, LinearScaleOptions as bm, LinearScale as bn, LogarithmicScaleOptions as bo, LogarithmicScale as bp, TimeScaleOptions as bq, TimeScale as br, TimeSeriesScale as bs, RadialLinearScaleOptions as bt, RadialLinearScale as bu, CartesianScaleTypeRegistry as bv, RadialScaleTypeRegistry as bw, ScaleTypeRegistry as bx, ScaleType as by, ChartTypeRegistry as bz, ScriptableOptions as c, ScriptableAndArray as d, ScriptableAndArrayOptions as e, ParsingOptions as f, ControllerDatasetOptions as g, BarControllerChartOptions as h, BarController as i, BubbleControllerDatasetOptions as j, BubbleDataPoint as k, BubbleController as l, LineControllerChartOptions as m, LineController as n, ScatterControllerDatasetOptions as o, ScatterDataPoint as p, ScatterControllerChartOptions as q, ScatterController as r, DoughnutAnimationOptions as s, DoughnutControllerChartOptions as t, DoughnutDataPoint as u, DoughnutController as v, PieControllerDatasetOptions as w, PieControllerChartOptions as x, PieAnimationOptions as y, PieDataPoint as z };
